                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if (!empty($item->image_small) && file_exists(public_path($item->image_small)))
                                                <img src="{{ asset($item->image_small) }}" alt="product-image" style="height: 50px" class="img-thumbnail mr-2">
                                            @else
                                        ...
                                        <td class="d-flex">
                                            ...
                                            <div class="btn-group">
                                                <a href="{{ route('admin.service.detail', $item->id) }}" class="btn btn-sm btn-dark" data-toggle="tooltip" title="View">
                                                    <i class="fa fa-eye"></i>
                                                </a>

                                                <a href="{{ route('admin.service.edit', $item->id) }}" class="btn btn-sm btn-dark" data-toggle="tooltip" title="Edit">
                                                    <i class="fa fa-edit"></i>
                                                </a>

                                                <a href="{{ route('admin.service.delete', $item->id) }}" class="btn btn-sm btn-dark" onclick="return confirm('Are you sure ?')" data-toggle="tooltip" title="Delete">
