        ...
        <div class="row pb-5">
            <div class="col-lg-8 col-md-12">
                <div class="blog_list mb-lg-5 mb-md-5 mb-4">
                    ...
                    <div class="blogimg">
                        <img src="{{asset('blogs.uploads')}}/{{$item->image}}" class="img-fluid" alt="no-image" width="85px">
            ...
            <div class="col-lg-4 col-md-12 pl-lg-5">
                ...
                <select class="form-control w-100" id="exampleFormControlSelect1">
                    <option selected="" disabled="">--Select all  category--</option>
                    @foreach ($blogs as $item)
                    <option >{{$item->blog_categories}}</option>
                ...
                <div class="col-lg-12 col-md-6">
                    ...
                    <div class="row event_c mt-lg-4 mt-md-4 mt-2">
                        ...
                        <div class="col-md-7 col-8 pl-0">
                            ...
                            <p class="mb-0"><i class="fa fa-calendar mr-1" aria-hidden="true"></i>{{$item->created_at}}</p>
                        </div>
                    </div>
                    @endforeach
