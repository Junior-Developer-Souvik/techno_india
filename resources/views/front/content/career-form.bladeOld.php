                                    ...
                                    <div class="form-box">
                                            ...
                                            <div class="col-lg-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        <p id="error_fname" class="text-danger"></p>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control"
                                                        placeholder="Enter your DOB" name="date_of_birth" id="date_of_birth">
                                                        <p id="error_date_ofb" class="text-danger"></p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <p id="otp_message" class="font-weight-bold text-end"></p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group phone-input-group" id="otp_full_div">
                                                    <div class="phone-number-col phone-otp-col email-otp-col">
                                                        <label class="form-label">Enter OTP received on the email above
                                                ...
                                                <p id="valid_otp_message" class="font-weight-bold text-end"></p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-6 col-12">
                                            ...
                                            <div class="col-lg-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        <p id="error_x_school_name" class="text-danger"></p>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        <p id="error_x_board_name" class="text-danger"></p>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <p id="error_x_percentage" class="text-danger"></p>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <p id="error_x_passing_year" class="text-danger"></p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <p id="error_xii_school_name" class="text-danger"></p>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <p id="error_xii_board_name" class="text-danger"></p>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <p id="error_xii_percentage" class="text-danger"></p>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <p id="error_xii_passing_year" class="text-danger"></p>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-lg-6 col-12">
                                                <div class="form-group">
                                                    <label class="form-label">Qualification <span
                                                            class="required">*</span></label>
                                                    <select class="form-control" name="after_xii_qualification" id="after_xii_qualification">
                                                    ...
                                                    <p id="error_after_xii_qualification" class="text-danger"></p>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-12">
                                                <div class="form-group">
                                                    <label class="form-label">Institution Name <span
                                                            class="required">*</span></label>
                                                    <input type="text" class="form-control"
                                                        placeholder="Enter your institution name" name="after_xii_institute_name" id="after_xii_institute_name">
                                                    <p id="error_after_xii_institute_name" class="text-danger"></p>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        placeholder="Enter affiliated board/university name" name="after_xii_institute_board" id="after_xii_institute_board">
                                                    <p id="error_after_xii_institute_board" class="text-danger"></p>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        placeholder="Enter your area of specialisation" name="after_xii_institute_stream" id="after_xii_institute_stream">
                                                    <p id="error_after_xii_institute_stream" class="text-danger"></p>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-12">
                                                <div class="form-group">
                                                    <label class="form-label">Percentage Acquired <span
                                                            class="required">*</span></label>
                                                    <input type="text" class="form-control"
                                                        placeholder="Enter percentage acquired" name="after_xii_institute_percentage" id="after_xii_institute_percentage">
                                                    <p id="error_after_xii_institute_percentage" class="text-danger"></p>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-12">
                                                <div class="form-group">
                                                    <label class="form-label">Passing Year <span
                                                            class="required">*</span></label>
                                                    <select class="form-control" name="after_xii_institute_passing_year" id="after_xii_institute_passing_year">
                                                        <option selected disabled>Select passing year</option>
                                                        @for ($year = 1980; $year <= date("Y"); $year++)
                                                        <option value="{{$year}}">{{$year}}</option>
                                                        @endfor
                                                    </select>
                                                    <p id="error_after_xii_institute_passing_year" class="text-danger"></p>
                                                </div>
                                            </div>
                                        </div>

                                        {{-- <div class="add-cta-row">
                                            <button type="button" class="btn btn-theme btn-add">
                                        ...
                                        <div class="row" id="work_experience_div">
                                            <div class="col-lg-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control experience-type" placeholder="Enter experience type" name="experience_type[]" required value="Experience Type">
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-12">
                                                <div class="form-group">
                                                    <label class="form-label">Experience Duration <span class="required">*</span></label>
                                                    <input type="text" class="form-control experience-duration" placeholder="Enter experience duration" name="experience_duration[]" required value="Experience Duration">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <p id="error_present_salary" class="text-danger"></p>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <p id="error_expected_salasry" class="text-danger"></p>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <p id="error_join_time" class="text-danger"></p>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-12">
                                                <div class="form-group">
                                            ...
                                            <div class="col-12" id="mentionReferrence">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        <p id="error_referrence_details" class="text-danger"></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-lg-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="applied_post" id="applied_post">
                                                        <option selected disabled>Select applied post</option>
                                                        <option value="Vice Principal">Vice Principal</option>
                                                        <option value="Teacher">Teacher</option>
                                                    </select>
                                                    <p id="error_applied_post" class="text-danger"></p>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="unit_name" id="unit_name">
                                                        ...
                                                        <option value="TIGPS Siliguri">TIGPS Siliguri</option>
                                                        <option value="TIGPS Nabadwip">TIGPS Nabadwip</option>
                                                    </select>
                                                    <p id="error_unit_name" class="text-danger"></p>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-12">
                                                <div class="form-group">
                                                    <label class="form-label">Subject: <span
                                                        ...
                                                        <p id="error_subject" class="text-danger"></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-box">
                                        ...
                                        <div class="row upload-row">
                                            <div class="col-lg-6 col-12 left-col">
                                                ...
                                                <p id="error_aadhar_card_file" class="text-danger"></p>
                                            </div>
                                        ...
                                        <div class="row upload-row">
                                            <div class="col-lg-6 col-12 left-col">
                                                ...
                                                <p>Note: Only .jpg, .jpeg, .png file formats supported. File size must
                                                    ...
                                                    <p id="error_pan_card_file" class="text-danger"></p>
                                            </div>
                                            <div class="col-lg-6 col-12 right-col">
                                                <div class="doc-img-box">
                                        ...
                                        <div class="row upload-row">
                                            <div class="col-lg-6 col-12 left-col">
                                                ...
                                                <p>Note: Only .pdf, .doc, .docx file formats supported. File size must
                                                    ...
                                                    <p id="error_resume_file" class="text-danger"></p>
                                            </div>
                                            <div class="col-lg-6 col-12 right-col">
                                                <div class="doc-img-box">
                                        ...
                                        <div class="row upload-row">
                                            <div class="col-lg-6 col-12 left-col">
                                                ...
                                                <p>Note: Only .jpg, .jpeg, .png file formats supported. File size must
                                                    ...
                                                    <p id="error_signature" class="text-danger"></p>
                                            </div>
                                            <div class="col-lg-6 col-12 right-col">
                                                <div class="doc-img-box">
                                        ...
                                        <div class="row upload-row">
                                            <div class="col-lg-6 col-12 left-col">
                                                ...
                                                <p>Note: Only .jpg, .jpeg, .png file formats supported. File size must
                                                    ...
                                                    <p id="error_x_admit_card" class="text-danger"></p>
                                            </div>
                                            <div class="col-lg-6 col-12 right-col">
                                                <div class="doc-img-box">
                                        ...
                                        <div class="row upload-row">
                                            <div class="col-lg-6 col-12 left-col">
                                                ...
                                                <p>Note: Only .jpg, .jpeg, .png file formats supported. File size must
                                                    ...
                                                    <p id="error_image_file" class="text-danger"></p>
                                            </div>
                                            <div class="col-lg-6 col-12 right-col">
                                                <div class="doc-img-box">
   ...
   $(document).ready(function() {
        ...
        $("#add_experience").click(function() {
            var experienceEntry = `<div class="row">
                ...
                <div class="col-lg-12">
                    <button class="btn btn-danger remove-experience">Remove</button>
                </div></div>`;
        ...
        if (allFilled) {
            ...
            var enteredOTP = otpValues.join('');
                ...
                if (enteredOTP === storedOTPArray) {
                    ...
                    setTimeout(function() {
                        $('#validate_otp').html('Validate OTP');
                        $('#valid_otp_message').html('<span style="color: red;">Entered OTP does not match the OTP on file. Please verify and try again.</span>');
                    }, 2000);
