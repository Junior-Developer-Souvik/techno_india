                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @if (!empty($data->image_small) && file_exists(public_path($data->image_small)))
                            <img src="{{ asset($data->image_small) }}" alt="product-image" style="height: 50px" class="img-thumbnail mr-2 mb-3">
                        @else
                            <img src="{{ asset('backend-assets/images/placeholder.jpg') }}" alt="product-image" style="height: 50px" class="mr-2 mb-3">
                        @endif
