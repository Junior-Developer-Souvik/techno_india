                                            ...
                                            <div class="col-12">
                                                <div class="form-group phone-input-group" id="otp_full_div">
                                                    <div class="phone-number-col phone-otp-col email-otp-col">
                                                        ...
                                                        <p id="valid_otp_message" class="font-weight-bold text-end success-msg"></p>
                                                    </div>
                                                    <div class="phone-cta-col">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <p id="error_after_xii_qualification" class="text-danger err-msg"></p>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <p id="error_after_xii_institute_name" class="text-danger err-msg"></p>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <p id="error_after_xii_institute_board" class="text-danger err-msg"></p>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <p id="error_after_xii_institute_stream" class="text-danger err-msg"></p>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <p id="error_after_xii_institute_percentage" class="text-danger err-msg"></p>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <p id="error_after_xii_institute_passing_year" class="text-danger err-msg"></p>
                                                </div>
                                            </div>
                                        </div>
